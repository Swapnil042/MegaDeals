...
if (isset($_POST['btnSugnup'])) {
        ...
        {        
            ...
            if(count($errors) == 0)
            {
                ...
                $a = $_SESSION['name'];
                $sql = "update user_info set name ='".$UserName."' ,password ='".$Password."' ,email='".$Email."',phone_number='".$PhoneNumber."' where name='".$a."'";
        ...
        <div class="header-middle"><!--header-middle-->
         ...
         <div class="well" style="background-color: white;width:400px;height:500px;position: absolute;margin-left : 30%;margin-top:2%;float:right;overflow:auto;">
            ...
            <form action="" method="POST">
                ...
                <input type="submit" name="btnSugnup" value="Update" class="btn btn-success">
            </form>
        </div>
