...
if (isset($_POST['btnLogin'])) {
        ...
        {        
            ...
            {
                $errors[15] = "Enter User Name";

            }     
            if(empty($_POST['txtLoginPassword']))
            {
                $errors[16] = "Enter Password";
            }
            if(count($errors) == 0)
            {
                ...
                if($result=(mysqli_query($con, $sql)))
                {
                    ...
                    {   
                        ...
                        $errors[17]="Incorrect username and password";
                    }
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
                    ...
                    <input type="text" name="txtLoginUsername" id="Textbox" class="form-control" value="<?php if(isset($_POST['txtLoginUsername'])) echo $_POST['txtLoginUsername']; ?>">
                    <p id="p1"><?php if(isset($errors[15])) echo $errors[15]; ?></p>
                    
                    <br/>Password<span style="color:red">*</span><br/>
                    <input type="password" name="txtLoginPassword" id="Textbox"class="form-control" value="<?php if(isset($_POST['txtLoginPassword'])) echo $_POST['txtLoginPassword']; ?>">
                    <p id="p1"><?php if(isset($errors[16])) echo $errors[16]; ?></p>
                    <p id="p1"><?php if(isset($errors[17])) echo $errors[17]; ?></p>
                    
                    <input type="checkbox" name="cbRememder">Remember me<br/><br/>
